        ...
        <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <input
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-[#ff4f00]/10 focus:border-[#ff4f00] transition"
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <select
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-[#ff4f00]/10 focus:border-[#ff4f00] transition disabled:bg-slate-50 disabled:cursor-not-allowed"
              >
          ...
          <div>
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 border border-slate-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-[#ff4f00]/10 focus:border-[#ff4f00] transition resize-none"
            />
            {errors.street && <p className="text-xs text-red-600 mt-1">{errors.street}</p>}
          </div>

          <label className="flex items-center gap-2 cursor-pointer select-none">
            <input type="checkbox" checked={form.isDefault} onChange={(e) => setForm((prev) => ({ ...prev, isDefault: e.target.checked }))} className="h-4 w-4 text-[#ff4f00] border-slate-300 rounded focus:ring-[#ff4f00] cursor-pointer" />
            <span className="text-sm text-slate-600">Set as default address</span>
          </label>
        </div>

        <div className="px-6 py-4 bg-slate-50 flex justify-end gap-3">
          <button onClick={onClose} className="px-6 py-2 rounded-xl border border-slate-300 text-slate-700 text-sm font-semibold hover:bg-slate-100 transition-colors">
            Cancel
          </button>
          <button onClick={handleSubmit} className="px-6 py-2 rounded-xl bg-[#ff4f00] text-white text-sm font-bold shadow-md shadow-[#ff4f00]/10 hover:bg-[#ff4f00]/95 transition-all">
            Save address
          </button>
        </div>
      </div>
