...
const TABS = [
  ...
  { key: "RefundPickupCreated", label: "Awaiting Pickup" },
  { key: "RefundShipping", label: "In Transit" },
  { key: "RefundReceived", label: "Received" },
  { key: "RefundInspectionPending", label: "Under Review" },
