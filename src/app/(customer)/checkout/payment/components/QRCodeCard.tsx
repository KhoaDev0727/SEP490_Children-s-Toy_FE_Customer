...
export default function QRCodeCard({
  ...
  return (
    <div className="flex flex-col items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-lg p-8 gap-6 w-full">
      {/* Title */}
      ...
      <div className="relative">
        ...
        <div className="absolute -top-1 -left-1 w-6 h-6 border-t-2 border-l-2 border-orange-500 rounded-tl-md" />
        <div className="absolute -top-1 -right-1 w-6 h-6 border-t-2 border-r-2 border-orange-500 rounded-tr-md" />
        <div className="absolute -bottom-1 -left-1 w-6 h-6 border-b-2 border-l-2 border-orange-500 rounded-bl-md" />
        <div className="absolute -bottom-1 -right-1 w-6 h-6 border-b-2 border-r-2 border-orange-500 rounded-br-md" />
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className={[
              ...
              isUrgent ? "text-red-500" : "text-slate-800 dark:text-slate-100",
            ].join(" ")}>
              {minutes}:{seconds}
            </p>
      ...
      {/* Scan hint */}
      <div className="flex items-center gap-2 bg-orange-50 dark:bg-orange-950/30 border border-orange-100 dark:border-orange-900/50 rounded-full px-4 py-2">
      ...
      {effectiveExpired && (
        <button
          ...
          className="w-full py-2.5 rounded-xl text-sm font-bold bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white transition-all active:scale-95 flex items-center justify-center gap-2"
        >
          {isRefreshing ? (
            <>
