...
/**
 * Poll GET /api/withdrawals/{withdrawalId} every 3 seconds, up to 2 minutes.
 * When status changes to SUCCESS / FAILED -> calls onFinished(status, data).
 * If timeout occurs and still PENDING/PROCESSING -> sets isTimedOut = true.
 */
