  ...
  return (
    <div
      ...
      style={{
        ...
        color: "#261812",
        minHeight: "calc(100vh - 400px)", // Dynamic adjustment between Header and Footer
      }}
    >
      {/* Background Texture */}
      <div
      ...
      <div className="max-w-3xl mx-auto w-full flex flex-col items-center text-center gap-8 relative z-10">
        ...
        <div className="flex flex-col items-center gap-4 max-w-lg">
          ...
          >
            We couldn't find the content you requested. Don't worry, go back to the homepage to continue exploring the toy world!
          </p>
        </div>
