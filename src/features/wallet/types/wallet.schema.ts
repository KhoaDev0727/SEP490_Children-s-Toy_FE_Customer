...
export const createWalletSchema = z
  .object({
    ...
    confirmPin: z
      .string()
      .regex(PIN_REGEX, "Confirm PIN must be exactly 6 digits."),
  })
...
export const changeWalletPinSchema = z
  .object({
    ...
    confirmNewPin: z
      .string()
      .regex(PIN_REGEX, "Confirm new PIN must be exactly 6 digits."),
  })
...
export const createSePayTopUpQrSchema = z.object({
  amount: z
    ...
    .refine(
      (amount) =>
        QUICK_TOP_UP_AMOUNTS.includes(
          amount as (typeof QUICK_TOP_UP_AMOUNTS)[number],
        ),
      {
...
export type VerifyForgotWalletPinOtpFormValues = z.infer<
  typeof verifyForgotWalletPinOtpSchema
>;
export type ResetForgotWalletPinFormValues = z.infer<
  typeof resetForgotWalletPinSchema
>;
export type CreateSePayTopUpQrFormValues = z.infer<
  typeof createSePayTopUpQrSchema
>;
