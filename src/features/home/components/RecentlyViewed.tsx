...
export default function RecentlyViewed() {
  return (
    <section>
      <h3 className="text-xl font-bold text-slate-900 mb-6">Sản phẩm đã xem gần đây</h3>
